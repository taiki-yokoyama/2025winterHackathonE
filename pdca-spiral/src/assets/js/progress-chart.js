// Progress Chart using Chart.js - 週次平均スコアの折れ線グラフ
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Get weekly chart data from global variable
    const data = typeof weeklyChartData !== "undefined" ? weeklyChartData : [];
    ...
    // Compare recent 2 weeks average vs overall average
    let trend = "stable";
    if (scores.length >= 2) {
        const recentScores = scores.slice(-2); // Last 2 weeks
        const avgRecent =
